...
# OUTLINE: Installation notes for FUSION tools ----
## install ----
...
# OUTLINE: Define helper functions ----
# funcion ----
...
names(sumstat) <- c("chr","pos","A2","A1","SNP","nearest_genes","pval","mlogp","beta",
...
# 讀權重檔案
"C:\Users\user\Desktop\TCGA-HNSC.TUMOR\TCGA-HNSC.TUMOR.TRIT1_54802.wgt.RDat"
...
# OUTLINE: Extract fields from TWAS result strings ----
## string extract ----
"1:123" -> "123"
str_extract("1:123" , "(?<=\\:)\\d+")
