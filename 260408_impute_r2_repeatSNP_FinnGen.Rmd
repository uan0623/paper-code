...
使用做好的 C:/Peter/QN_before_eQTL/r2_filter_%s/outcome/QN_maf_gt_T_pvalue_FDR_R2_%s.txt 等4 個檔案 跑
## prepare

### find repeat snp (bed)

6  snp_r2filter_0.8.txt: hg18 -> hg38 轉失敗的 19:46895802
7  snp_r2filter_0.7.txt: hg18 -> hg38 轉失敗的 19:46895802	
8  snp_r2filter_0.8.txt: 都成功
9  snp_r2filter_0.9.txt: 都成功

```{r}
finngen <- fread("D:/oral_cancer/TWAS/summary_stat/FinnGen/C3_ORALCAVITY_EXALLC")
gt_N <- fread("C:/Peter/QN_before_eQTL/r2_filter_0.8/outcome/QN_maf_gt_T_pvalue_FDR_R2_0.8.txt")
...
fwrite(data.table(a=paste0("chr",gt_N$CHR),
       ...
       "C:/Peter/QN_before_eQTL/r2_filter_0.8/trash/snp_r2filter_0.8.txt",
         row.names = F, col.names = F, sep = "\t")


# 檔案 snp_r2filter.txt 放進 leftover 轉換成 snp_r2filter_success.bed
a <- fread("C:/Peter/QN_before_eQTL/r2_filter_0.8/trash/snp_r2filter_hg18TOhg38_0.8.bed")
...
fwrite(repeat_snp,
       "C:/Peter/QN_before_eQTL/r2_filter_0.8/outcome/QN_maf_gt_N_pvalue_FDR_repeatSNP.txt",
...
fwrite(gt_N,
       "C:/Peter/QN_before_eQTL/r2_filter_0.8/outcome/QN_maf_gt_N_pvalue_FDR_MixFinngenPval.txt",
         row.names = F, col.names = T, sep = "\t")
...
gt_N <- fread("C:/Peter/QN_before_eQTL/r2_filter_0.8/outcome/QN_maf_gt_N_pvalue_FDR_MixFinngenPval.txt")
...
for(chr_i in chr_list){
  ...
  # 存檔
  fwrite(finngen_chr,
         sprintf("C:/Peter/QN_before_eQTL/r2_filter_0.8/outcome/finngen_cisSNP_gt_N_chr%s.txt", chr_i),
         sep = "\t",
         row.names = FALSE,
         col.names = TRUE)
...
for (i in 1:22) {
  overlaps <- sprintf("C:/Peter/QN_before_eQTL/r2_filter_0.8/outcome/finngen_cisSNP_gt_N_chr%d.txt", i) %>%
    fread() 
  ...
  fwrite(overlaps,
         sprintf("C:/Peter/QN_before_eQTL/r2_filter_0.8/outcome/finngen_cisSNP_gt_N_chr%d.txt", i),
         sep = "\t",
         row.names = FALSE,
         col.names = TRUE)
}
...
for (chr_i in 1:22) {
  ...
  a <- sprintf("C:/Peter/QN_before_eQTL/r2_filter_0.8/outcome/finngen_cisSNP_gt_N_chr%d.txt", chr_i) %>% 
    fread()
...
fwrite(df,
       "C:/Peter/QN_before_eQTL/r2_filter_0.8/outcome/finngen_sigSNP_chr1-22.txt",
        row.names = F, col.names = T, sep = "\t")
```
...
fwrite(df_most,
       "C:/Peter/QN_before_eQTL/r2_filter_0.8/outcome/QN_maf_gt_N_pvalue_FDR_MixFinngenPval_5.txt",
        row.names = F, col.names = T, sep = "\t")
```
...
df_most <- fread("C:/Peter/QN_before_eQTL/r2_filter_0.8/outcome/QN_maf_gt_N_pvalue_FDR_MixFinngenPval_5.txt")
...
fwrite(data.table(a=paste0("chr",MOSTpval_info$CHR),
       ...
       "C:/Peter/QN_before_eQTL/r2_filter_0.8/trash/QN_MixFinngenPval_5_SNPhg38.txt",
         row.names = F, col.names = F, sep = "\t")


# 把 MOSTpval_info$snp_hg38 轉成 hg19 ，檔案 MixFinngenPval_5_SNPhg38.txt 放進leftover轉換成 MixFinngenPval_5_SNPhg38_success.bed
a <- fread("C:/Peter/QN_before_eQTL/r2_filter_0.8/trash/QN_MixFinngenPval_5_SNPhg38TOhg19_success.bed")
...
fwrite(MOSTpval_info,
       "C:/Peter/QN_before_eQTL/r2_filter_0.8/outcome/QN_maf_gt_N_pvalue_FDR_MixFinngenPval_6.txt",
        row.names = F, col.names = T, sep = "\t")


# 重新讀取，才會把 MOSTpval_info$alt 從 NA 讀成 ""
MOSTpval_info <- fread("C:/Peter/QN_before_eQTL/r2_filter_0.8/outcome/QN_maf_gt_N_pvalue_FDR_MixFinngenPval_6.txt")

# 紀錄不在 finngen snp
not_in_finngen <- MOSTpval_info[MOSTpval_info$alt=="",c("gt_N_hg19","gt_N_hg38")]
fwrite(data.table(k = not_in_finngen$gt_N_hg19),
       "C:/Peter/QN_before_eQTL/r2_filter_0.8/outcome/not_in_finngen_hg19SNP.txt",
       row.names = F, col.names = F, sep = "\n") 
...
```{r}
export EQTL_LIST="/mnt/c/Peter/QN_before_eQTL/r2_filter_0.8/outcome/not_in_finngen_hg19SNP.txt"
...
for chr in {1..22}; do
    ...
    --ld-window-r2 0 \
    --list-all \
    --out "/mnt/c/Peter/QN_before_eQTL/r2_filter_0.8/trash/no_intersect_LD/EUR/EUR_LDchr${chr}" &
...
for chr in {1..22}; do
    ...
    plink1.9 \
        ...
        --ld-window-r2 0 \
        --list-all \
        --out "/mnt/c/Peter/QN_before_eQTL/r2_filter_0.8/trash/no_intersect_LD/FIN/FIN_LDchr${chr}" &
...
```{r}
gt_N_MOSTsnp <- fread("C:/Peter/QN_before_eQTL/r2_filter_0.8/outcome/finngen_sigSNP_chr1-22.txt")
...
fwrite(a,
       "C:/Peter/QN_before_eQTL/r2_filter_0.8/outcome/QN_maf_gt_N_pvalue_FDR_MixFinngenPval_2.txt",
        row.names = F, col.names = T, sep = "\t")
...
gt_N <- fread("C:/Peter/QN_before_eQTL/r2_filter_0.8/outcome/QN_maf_gt_N_pvalue_FDR_MixFinngenPval_2.txt")
...
fwrite(data.table(kk = a$hg19_snpID %>% 
                   unique()),
       "C:/Peter/QN_before_eQTL/r2_filter_0.8/outcome/QN_eQTL_SNPhg19.txt",
       row.names = F, col.names = T, sep = "\t")
```
...
for (i in 1:22) {
  file_path <- sprintf("C:/Peter/QN_before_eQTL/r2_filter_0.8/trash/no_intersect_LD/EUR/EUR_LDchr%d.ld", i)
...
most_pval_info <- fread("C:/Peter/QN_before_eQTL/r2_filter_0.8/outcome/QN_maf_gt_N_pvalue_FDR_MixFinngenPval_6.txt")
...
fwrite(data.table(k = setdiff(not_in_finngen$gt_N_hg19, df_most$gt_N_hg19 )),
       "C:/Peter/QN_before_eQTL/r2_filter_0.8/outcome/not_in_finngen_1000gEUR_hg19SNP.txt",
       row.names = F, col.names = F, sep = "\n") 
```
...
fwrite(a,
       "C:/Peter/QN_before_eQTL/r2_filter_0.8/outcome/QN_MixFinngenPval_7_EUR.txt",
        row.names = F, col.names = T, sep = "\t")
...
# 新增 MOST_snp_hg19 ####
a <-fread("C:/Peter/QN_before_eQTL/r2_filter_0.8/outcome/QN_MixFinngenPval_7_EUR.txt")
...
fwrite(data.table(a=paste0("chr",most_snp$chr),
                  b=most_snp$pos, 
                  c=most_snp$pos ) ,
       "C:/Peter/QN_before_eQTL/r2_filter_0.8/trash/most_snp.txt",
       row.names = F, col.names = F, sep = "\t")

# 把 MOST_snp_nearest_hg38 轉成 hg19 ，檔案 most_snp.txt 放進leftover轉換成  C:/Peter/QN_before_eQTL/r2_filter_0.8/trash/most_snphg19.bed
snp_hg19 <- fread("C:/Peter/QN_before_eQTL/r2_filter_0.8/trash/most_SNPhg38TOhg19.bed",header=F)
...
k <- fread("C:/Peter/QN_before_eQTL/r2_filter_0.8/outcome/QN_MixFinngenPval_7_EUR.txt")
...
for (i in 1:22) {
  ...
  file_path <- sprintf("C:/Peter/QN_before_eQTL/r2_filter_0.8/trash/no_intersect_LD/FIN/FIN_LDchr%d.ld", i)
...
fwrite(data.table(k = setdiff(not_in_finngen$gt_N_hg19, df_most$gt_N_hg19 )),
       "C:/Peter/QN_before_eQTL/r2_filter_0.8/outcome/not_in_finngen_1000gFIN_hg19SNP.txt",
       row.names = F, col.names = F, sep = "\n") 
```
...
test_eur <- fread("C:/Peter/QN_before_eQTL/r2_filter_0.8/trash/most_snp.txt")
...
fwrite(a,
       "C:/Peter/QN_before_eQTL/r2_filter_0.8/outcome/QN_MixFinngenPval_7_FIN.txt",
        row.names = F, col.names = T, sep = "\t")
...
k <- fread("C:/Peter/QN_before_eQTL/r2_filter_0.8/outcome/QN_MixFinngenPval_7_FIN.txt")
...
```{r}
eur <- fread("C:/Peter/QN_before_eQTL/r2_filter_0.8/outcome/QN_MixFinngenPval_7_FIN.txt")
