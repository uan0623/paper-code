# ============================================================
# TITLE: eQTL Result Processing QN
# SUBTITLE: Process quantile-normalized eQTL results and annotate/filter SNP signals.
# SEARCH TAGS: eQTL, QN, result, FDR, annotation, SNP, R2
...
# OUTLINE: Filter cis SNPs by LD R2 ----
## R2 filter cisSNP ----
...
# OUTLINE: Process QN eQTL results ----
## 處理 QN 後 eQTL ----
...
# OUTLINE: Select SNPs with R2 greater than 0.6 ----
### 算 R2>0.6 snp ----
...
# OUTLINE: Analyze no-filter QN eQTL results ----
## no filter ----
...
file_name <- c("C:/Peter/QN_before_eQTL/trash/QN_maf_gt_N_pvalue_FDR_R20.8.txt",
               "C:/Peter/QN_before_eQTL/trash/QN_maf_gt_T_pvalue_FDR_R20.8.txt")
...
# gt pvalue ----
a <- fread("C:/Peter/QN_before_eQTL/trash/QN_maf_gt_N_pvalue_FDR_R20.8.txt")
b <- fread("C:/Peter/QN_before_eQTL/trash/QN_maf_gt_T_pvalue_FDR_R20.8.txt")
...
for (i in file_name) {
  a <- paste0("C:/Peter/QN_before_eQTL/trash/",i,"_FDR_R20.8.txt") %>% 
    fread()
  k <- a[,.N ,by="Probe"]
...
# OUTLINE: Annotate variants with VEP ----
## VEP ----
...
# OUTLINE: Plot FDR and q-value summaries ----
## BH plot ----
