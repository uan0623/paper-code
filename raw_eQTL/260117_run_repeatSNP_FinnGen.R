...
for (r2_threshold in c("no", "0.6", "0.7", "0.8", "0.9")) {
  data_1 <- fread(
    sprintf(
      "C:/Peter/rawData_eQTL/r2_filter_%s/outcome/raw_MixFinngenPval_7_EUR.txt",
      r2_threshold
    )
  )
...
plot(data_sub_T$FDR,
  ...
  pch = ".",
  col = "black",
  main = "Tumor Part BH V.S. q-value",
  xlab = "BH",
  ylab = "q-value",
  type = "n"
)
abline(a = 0, b = 1, col = "red", lwd = 2)
points(data_sub_T$FDR, data_sub_T$qvalue,
  col = "black",
  pch = "."
)
...
plot(data_sub_N$FDR,
  ...
  pch = ".",
  col = "black",
  main = "Normal Part BH V.S. q-value",
  xlab = "BH",
  ylab = "q-value",
  type = "n"
)
abline(a = 0, b = 1, col = "red", lwd = 2)
points(data_sub_N$FDR, data_sub_N$qvalue,
  col = "black",
  pch = "."
)
